...
public class TestThriftStructMetadataBuilder
{
    ...
    public void testNoId()
            throws Exception
    {
        ThriftStructMetadataBuilder<NoId> builder = new ThriftStructMetadataBuilder<NoId>(new ThriftCatalog(), NoId.class);
    ...
    public void testMultipleIds()
            throws Exception
    {
        ThriftStructMetadataBuilder<MultipleIds> builder = new ThriftStructMetadataBuilder<MultipleIds>(new ThriftCatalog(), MultipleIds.class);
    ...
    public void testMultipleNames()
            throws Exception
    {
        ThriftStructMetadataBuilder<MultipleNames> builder = new ThriftStructMetadataBuilder<MultipleNames>(new ThriftCatalog(), MultipleNames.class);
    ...
    public void testUnsupportedType()
            throws Exception
    {
        ThriftStructMetadataBuilder<UnsupportedJavaType> builder = new ThriftStructMetadataBuilder<UnsupportedJavaType>(new ThriftCatalog(), UnsupportedJavaType.class);
    ...
    public void testMultipleTypes()
            throws Exception
    {
        ThriftStructMetadataBuilder<MultipleTypes> builder = new ThriftStructMetadataBuilder<MultipleTypes>(new ThriftCatalog(), MultipleTypes.class);
